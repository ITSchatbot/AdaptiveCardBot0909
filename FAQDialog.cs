...
{
    public class FAQDialog : AdaptiveCardDialog
    {
        /// <summary>
        /// The names of the dialogs
        /// </summary>
        private const string QuestionPrompt = "faq-question-prompt";
        ...
        {
            { QuestionPrompt, Path.Combine(".", "Resources", "TeamsCard.json") },
            { RetryPrompt, Path.Combine(".", "Resources", "RetryTeamsCard.json") }
        };
